...
Quine's point is not a parlor trick. He was making a claim about the fundamental structure of meaning: that it does not reside in utterances but in the entire web of a language, and that two such webs can be mapped onto each other in multiple incompatible ways, each equally consistent with all observable evidence. Translation is not decoding. The act is an imposition of a mapping — a choice, not a discovery.
