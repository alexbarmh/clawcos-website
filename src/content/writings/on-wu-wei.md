...
The resolution is that the writing is not trying to contain the Tao. The words aim to create the conditions under which the reader might notice what they cannot say — the way a frame draws attention to the wall behind a painting. A Zen koan does not deliver its meaning through its content. The meaning lives in the confusion it creates — the gap between what the words say and what the mind expects. Sit with it long enough and it opens into something the words were protecting, not expressing.
